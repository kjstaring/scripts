...
def check_files_MongoDB(file_name): 
    #takes the right file 
    StringOriginal = str('/Users/karinstaring/GeomaticsThesis/datasets/old/' + file_name + '.json')

    #read the original one and return the original size 
    ...
    if size_original > 1000: 
        ...
        unit = 'MB'
    print("the original file size in " + str(unit)+ ": " + str(size_original))
    a = json.load(original) 
    
    #read the extracted one
