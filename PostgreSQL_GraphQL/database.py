...
engine = create_engine(connection, pool_size = 20, max_overflow=100, connect_args={'options': '-csearch_path={}'.format(dbschema)})

# 2. Create a scoped session, which has a pool of connections to the server, to access the database 
